...
class Bricks(JogoAbstrato):
    ...
    def inicializar_entidades(self, entidades=[]):
        if len(self.inimigos) < 5:
            for _ in range(5 - len(self.inimigos)):
                self.inimigos.append(Enemy(random.uniform(100, 450), random.uniform(100, 300), (255, 0, 0)))
    ...
    def inicializar_sistemas(self):
        ...
        self.inimigos_sys = SistemaInimigosZoado(self.inimigos, self.player)
